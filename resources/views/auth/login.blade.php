        ...
        <div class="col-md-5 col-lg-4">
            ...
            <div class="card login-card">
                <div class="card-body p-4">
                    <h5 class="card-title mb-4 fw-semibold text-center">Hesabınıza daxil olun</h5>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                                    value="{{ old('email') }}" placeholder="admin@stom.az" autofocus required>
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 d-flex align-items-center justify-content-between">
                            ...
                            <a href="{{ route('password.request') }}" class="text-primary small text-decoration-none">Şifrəni unutdum</a>
                            @endif
                        </div>
