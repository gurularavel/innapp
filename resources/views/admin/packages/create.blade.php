                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" min="0"
                                   ...
                                   id="price_per_seat" name="price_per_seat" value="{{ old('price_per_seat', '20.00') }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" min="1"
                                   ...
                                   id="min_seats" name="min_seats" value="{{ old('min_seats', 1) }}">
                            @error('min_seats')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" min="1"
                                   ...
                                   id="max_seats" name="max_seats" value="{{ old('max_seats') }}"
                                   placeholder="Boş = limitsiz">
                            @error('max_seats')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                      ...
                                      placeholder="Paketin qısa izahı">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
