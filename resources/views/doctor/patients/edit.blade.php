    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('doctor.patients.show', $patient) }}" class="btn btn-sm btn-outline-secondary">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('doctor.patients.update', $patient) }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                   id="phone" name="phone" value="{{ old('phone', $patient->phone) }}" placeholder="+994XX XXX XX XX">
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mt-4 d-flex gap-2">
                        ...
                        <a href="{{ route('doctor.patients.show', $patient) }}" class="btn btn-outline-secondary">Ləğv et</a>
                    </div>
                </form>
            </div>
        </div>
