...
@section('title', 'Xidmət Növünü Düzəlt')
@section('page-title', 'Xidmət Növünü Düzəlt')
    ...
    <div class="col-lg-6">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center">
                <h6 class="mb-0 fw-semibold">{{ $treatmentType->name }} — Düzəliş</h6>
                <a href="{{ route('doctor.treatment-types.index') }}" class="btn btn-sm btn-outline-secondary">
                    <i class="bi bi-arrow-left me-1"></i>Geri
                </a>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('doctor.treatment-types.update', $treatmentType) }}">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                               id="name" name="name" value="{{ old('name', $treatmentType->name) }}" required autofocus>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" min="0"
                               ...
                               id="price" name="price"
                               value="{{ old('price', $treatmentType->price) }}"
                               placeholder="Boş = qiymət yoxdur">
                        @error('price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" min="5" step="5"
                               ...
                               value="{{ old('duration_minutes', $treatmentType->duration_minutes ?? 30) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <input type="color" class="form-control form-control-color @error('color') is-invalid @enderror"
                                   id="color" name="color"
                                   value="{{ old('color', $treatmentType->color ?? '#3788d8') }}"
