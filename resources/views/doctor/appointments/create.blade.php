    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('doctor.appointments.index') }}" class="btn btn-sm btn-outline-secondary">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('doctor.appointments.store') }}">
                    ...
                    <div class="mt-4 d-flex gap-2">
                        ...
                        <a href="{{ route('doctor.appointments.index') }}" class="btn btn-outline-secondary">Ləğv et</a>
                    </div>
                </form>
            </div>
        </div>
